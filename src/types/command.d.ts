...
declare type Command = {
   ...
   * category: 'general'
   */
  category: "convert" | "general" | "downloader" | "streaming" | "misc" | "owner" | "group"
   ...
   * @type {CommandObject}
   * @example
   * execute: async ({ client, message, command, prefix, args, arg }) => {
   *  await client.sendMessage(message.from, { text: `pong! ${arg}` })
   * }
   */
