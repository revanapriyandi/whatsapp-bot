...
const defaultOptions: StickerOptions = {
  author: "orionpro",
  pack: "whatsapp",
  id: "github.com/orionpro/whatsapp-bot " + randomBytes(4).toString("hex"),
  width: 512,
  fps: 25,
  loop: true,
  compress: 0
...
export class WASticker {
  ...
  #$_createExif() {
    const data = JSON.stringify({
      ...
      "sticker-pack-publisher-email": "mail@orion.tech", //idk what is this for
      "sticker-pack-publisher-website": `https://www.revanapriyandi.tech`, //idk what is this for
      ...(this.#opts.categories && this.#opts.categories?.length >= 1 ? { emojis: this.#opts.categories } : {}),
      "android-app-store-link": `https://play.google.com/store/apps/details?id=com.snowcorp.stickerly.android`, //idk what is this for
      "ios-app-store-link": `https://apps.apple.com/us/app/sticker-maker-studio/id1443326857` //idk what is this for
    })
